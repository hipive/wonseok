...
% Problem 3: 
% Solution 3: Hierarchical Graphical Modeling
...
%% --------------------------------------   Problem Description.    --------------------------------------
\textcolor{red}{In this study, we develop an advanced algorithm for mid-term probabilistic load forecasting. First, as mentioned above, many studies used a one-dimensional temperature scenario, whereas we sample the interrelated temperature and dew point  scenarios from their multivariate Gaussian distribution (MGD) using  probabilistic graphical model (PGM) and Gibbs sampling. In this process we also consider the daily patterns and dependency between hourly weather data using joint distribution of hourly random variables.} %%We compare the performance between our method to the single dimensional scenarios and also the  historical scenarios.
...
In the linear regression, it leads to the projection of solution vector onto the subspaces of observation data. On the contrary, in the quantile regression, it should be solved by techniques in the linear programing~\cite{SSSS}.
...
In this paper, we use \textit{cooperative game theory} as a cost allocation method based on benefit. Generally, game theory is divided into two. One is \textit{cooperative game theory} (CGT) and the other is \textit{non-cooperative game theory} (NCGT). NCGT do not seek collective gain through discussion or cooperation between the parties, but consider probabilistic value according to personal choice. The CGT can discussion each other. Thus, interested parties form aggregate called \textit{coalition}, pursue common benefit. Because of characteristic that participants can discussion, it can deduce more accurate result~\cite{zolezzi2002}. The possibility of discussion should be carried out with the game theory considering the combination of participants. Progressing the game theory in all cases can reveal the contribution of each participant in the game, enabling intrinsic characteristics. The structural features of the CGT used in the paper are as follows:
...
\begin{equation}
\sum\limits_{i\in{N}} x_{i} \leq v(N)
\end{equation}
Second equation means feasibility. The participants can't allocate more than they produce.
\begin{equation}
\sum\limits_{i\in{S}} x_{i} \geq v(S)
\end{equation}
\textit{S} is the subset of \textit{N},means coalition. The last axiom is that the participants in coalition should get pay-off at least they produce.
...
The cost allocation methodology proposed in this paper consists of time-driven scenarios rather that simple snap-shot. Each scenario consists of three steps, from planning to cost allocating, and in the final process, all scenarios are considered to determine the cost to be allocated.
...
\section{Simulation}
In this section, we proceed numerical experiments on specific zones. 
...
\subsection{Performance}
 ...
 We compared performce of 10 different forecasting model by pinball loss function. Each score is a summation of forecasting loss of 8 different zone, MA and whole ISO NE. As in Fig.5 model based on testing scenario which considered dependency of two differnt temperature and hourly correlation and XGboost with KDE showed best performance. GBM quantile regression showed
...
\begin{table}[!t]
	...
	\begin{tabular}{| c | c | c | c | }
		\hline
		Zone Name    & Our Performance  & Benchmark    \\  \hline
		CT	& 97.79 & 98.8     \\ \hline
		ME & 23.31  & 23.88      \\ \hline
		RI & 19.17 & 21.53     \\ \hline
		NH & 29.14 & 29.64      \\ \hline
		WCMASS & 49.5  & 55.25     \\ \hline
		SEMASS & 44.88 & 49.51      \\ \hline
		NEMASS & 70.93 & 73.16     \\ \hline
		MASS & 161.11 & 175.86      \\ \hline
...
\begin{tabular}{|c c c c|}
\hline
to & from & Rating(MW) & Reactance($\Omega$)\\[0.5ex]
\hline
1 & 4 & 2000 & 0.0576\\
\hline
4 & 5 & 1500 & 0.0920\\
...
\hline
\multirow{2}{*}{node} & \multirow{2}{*}{capacity(MW)} & \multicolumn{3}{l}{cost coefficient} \\
                      &                               & a           & b          & c          \\
\hline
GEN1 & 5000 & 0.1100 & 5.00 & 150\\
\hline
GEN2 & 8000 & 0.0850 & 1.20 & 600\\
\hline
GEN3 & 6000 & 0.1225 & 1.00 & 335\\
\hline
sub1 & 2000 & 1.7750 & 10 & 150\\
\hline
sub2 & 2000 & 2.2123 & 10 & 150\\
\hline
sub3 & 2000 & 1.8548 & 27 & 150\\
\hline
sub4 & 2000 & 2.3924 & 50 & 150\\
\hline
sub5 & 2000 & 1.9680 & 46 & 100\\
\hline
sub6 & 2000 & 1.7879 & 48 & 100\\
\hline
sub7 & 2000 & 1.8779 & 10 & 100\\
\hline
sub8 & 2000 & 2.0451 & 60 & 100\\
\hline
\end{tabular}
\end{table}
